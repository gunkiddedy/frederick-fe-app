<template>
	<!-- class cloud-data-source -->
  	<div class="cloud-data-source w-full lg:ml-120px lg:px-9 px-4 lg:pt-20 pt-32 pb-20 border-l-4 border-F2F3F7">
		...
		<!-- main -->
		<div class="main flex lg:flex-row flex-col justify-between items-start mt-14 lg:space-x-8 space-x-0 lg:space-y-0 space-y-8">
			...
			<div class="left-content lg:w-70-persen w-full flex flex-col space-y-8">
				...
				<div class="tabulator w-full lg:h-428px h-auto lg:pb-0 pb-4 rounded-lg border border-D2E3E7 bg-white pt-7 px-6 shadow-md">
					...
					<div class="lg:text-base text-sm text-011728 mt-8 mb-5">
						Select the cloud data source from which you’d like to contribute your data.
					</div>

					<!-- clouds -->
					<div class="clouds flex lg:flex-row flex-col items-center justify-between lg:space-x-4 space-x-0 lg:space-y-0 space-y-8">
						<!-- aws -->
						<div
							@click="toCloudService" 
							class="aws-card w-237px h-139px bg-FDFDFD rounded-lg shadow flex items-center justify-center">
							<img class="cursor-pointer" src="../assets/img/amazon-logo.png" alt="">
						</div>
						<!-- salesforce -->
						<div
							@click="toCloudService" 
							class="salesforce-card w-237px h-139px bg-FDFDFD rounded-lg shadow flex items-center justify-center">
							<img class="cursor-pointer" src="../assets/img/salesforce-logo.png" alt="">
						</div>
						<!-- hubspot -->
						<div
							@click="toCloudService" 
							class="hubspot-card w-237px h-139px bg-FDFDFD rounded-lg shadow flex items-center justify-center">
							<img class="cursor-pointer" src="../assets/img/hubspot-logo.png" alt="">
						</div>
					</div>

					<div class="text-sm text-6B737B mt-4">
...
<script>
	...
	export default {
		...
		methods: {
			toCloudService() {
				this.$router.push('/cloud-service')
			},
			toLocal() {
