<template>
	<!-- class cloud-service -->
  	<div class="cloud-service w-full lg:ml-120px lg:px-9 px-4 lg:pt-20 pt-32 pb-20 border-l-4 border-F2F3F7">
		...
		<div class="header flex lg:flex-row flex-col lg:space-y-0 space-y-4 justify-between items-start">
			...
			<div class="right flex items-center space-x-2">
				...
				<button class="text-white cursor-not-allowed bg-8269BD opacity-30 rounded-lg px-5 py-2 border border-8269BD focus:outline-none">
		...
		<div class="main flex lg:flex-row flex-col lg:space-y-0 space-y-8 justify-between items-start mt-14 lg:space-x-8 space-x-0">
			...
			<div class="left-content lg:w-70-persen w-full flex flex-col space-y-8">
				...
				<div class="tabulator w-full min-h-428px rounded-lg border border-D2E3E7 bg-white pt-7 px-6 pb-8 shadow-md">
					...
					<div class="tabs flex border-b border-D2E3E7 -ml-6 -mr-6 lg:pl-6 pl-2 lg:pr-0 pr-2">
						<button @click="toLocal" class="bg-F2FAFB w-204px h-62px lg:text-lg text-sm font-bold text-40243C border border-D2E3E7 rounded-tl-lg rounded-tr-lg">
							Local CSV
						</button>

						<button @click="toCloud" class="bg-white w-204px h-62px lg:text-lg text-sm font-bold text-3F7992 border border-D2E3E7 rounded-tl-lg rounded-tr-lg mx-1">
							Cloud Data Source
						</button>

						<button @click="toHome" class="bg-F2FAFB w-204px h-62px lg:text-lg text-sm font-bold text-3F7992 border border-D2E3E7 rounded-tl-lg rounded-tr-lg">
							Search Existing
						</button>
					</div>
					...
					<div
                        @click="back" 
                        class="back cursor-pointer flex items-center mt-11 space-x-3">
                        <img src="../assets/img/left-arrow.png" alt="">
                        <span class="text-base text-011728 font-bold">Back</span>
                    </div>

                    <!-- content cloud -->
                    <div class="content-cloud flex flex-col items-center space-y-12">
                        <img class="w-24 h-auto" src="../assets/img/amazon-logo.png" alt="">
                        
                        <div class="text lg:text-base text-sm text-011728">
                            Enter your AWS Credentials for the source S3 Bucket
                        </div>

                        <div class="wrap-input w-full flex flex-col space-y-6 lg:px-8 px-2">
                            <!-- input field -->
                            <div class="input-field flex flex-col items-start space-y-2 w-full">
                                <span class="text-011728 text-base font-bold">Source Bucket</span>
                                <input
                                    class="bg-F2FAFB border border-D2E3E7 w-full h-42px rounded-lg focus:outline-none px-4" 
                                    type="text" 
                                    name="" 
                            ...
                            <!-- input field -->
                            <div class="input-field flex flex-col items-start space-y-2 w-full">
                                <span class="text-011728 text-base font-bold">AWS Key</span>
                                <input
                                    class="bg-F2FAFB border border-D2E3E7 w-full h-42px rounded-lg focus:outline-none px-4" 
                                    type="text" 
                                    name="" 
                            ...
                            <!-- input field -->
                            <div class="input-field flex flex-col items-start space-y-2 w-full">
                                <span class="text-011728 text-base font-bold">AWS Secret Key</span>
                                <input
                                    class="bg-F2FAFB border border-D2E3E7 w-full h-42px rounded-lg focus:outline-none px-4" 
                                    type="text" 
                                    name="" 
					...
					<!-- footer -->
					<div class="footer flex lg:flex-row flex-col lg:space-y-0 space-y-4 items-center justify-between mt-14 px-6">
						<div class="text-sm text-6B737B">
							By loading your data, you agree to the <a href="#" class="underline">Terms of Service.</a>
						</div>

						<button
							@click="previewData"
							class="text-white bg-8269BD rounded-lg px-5 py-1 border border-8269BD focus:outline-none">
							Preview Dataset
						</button>
					</div>
	...
	export default {
		...
		data() {
			return {
				...
				lessThanTwo: 0,
				moreThanTwo: 0,
				buttonPreviewDataset: false,
			}
		},
		methods: {
			previewData() {
				this.$router.push('/preview-data')
			},
			back() {
					this.$router.go(-1)
			},
